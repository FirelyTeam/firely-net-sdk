...
namespace Hl7.Fhir.Rest
{
    ...
    {
        enum State { AsUri, Synchronized, AsProperties }
        public bool IsLocationOperation(string s)
        {
            return new string[] { 
        ...
        public static Uri SERVICE = new Uri("http://localhost/");
        ...
        private void deconstruct()
        {
            if (state == State.AsUri)
            {
                ...
                {
                    throw new InvalidOperationException("Cannot deconstruct foreign URI.");
                }
            }
        }
