...
namespace Hl7.Fhir.Serialization
{
    ...
    /// <summary>
    /// Provides a sequence of <see cref="ISourceNavigator"/> instances to efficiently
    ...
    /// </remarks>
    public interface INavigatorStream : ISeekableEnumerator<ISourceNavigator>, IDisposable
    {
