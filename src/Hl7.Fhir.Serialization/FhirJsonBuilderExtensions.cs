...
#pragma warning disable 612, 618
        ...
        public static void WriteTo(this IElementNavigator source, JsonWriter destination, FhirJsonBuilderSettings settings = null) =>
...
#pragma warning disable 612, 618
        [Obsolete("Please consider switching to ITypedElement (which is what the new parsers return).")]
        public static string ToJson(this IElementNavigator source, FhirJsonBuilderSettings settings = null)
              => SerializationUtil.WriteJsonToString(writer => source.WriteTo(writer, settings), settings?.Pretty ?? false);
#pragma warning restore 612, 618
