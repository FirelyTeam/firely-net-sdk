...
namespace Hl7.Fhir.Core.Tests.ElementModel
{
    ...
    public class PocoNavigatorTests
    {
        ...
        public void PocoTypedElementPocoRoundtrip()
        {
            ...
            var actual = patient.ToTypedElement(Model.Version.DSTU2).ToPoco<Model.DSTU2.Patient>(Model.Version.DSTU2);
        ...
        {
            var appointment = new Model.DSTU2.Appointment();
            ...
            var actual = appointment.ToTypedElement(Model.Version.DSTU2);
