...
namespace Hl7.Fhir.Core.Tests.Serialization
{
    ...
    public class CustomSerializationTests
    {
        ...
        public void NoOpSerializer()
        {
            ...
            var jsonSerializer = new FhirJsonSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new DoNothingCustomSerializer() });
        ...
        public void TestBeforeAndAfterSerializeComplex()
        {
            ...
            var xmlSerializer = new FhirXmlSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new InsertAdditionalMembersAroundCustomSerializer() });
            var xml = xmlSerializer.SerializeToString(pat);
            ...
            var jsonSerializer = new FhirJsonSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new InsertAdditionalMembersAroundCustomSerializer() });
            var json = jsonSerializer.SerializeToString(pat);
        ...
        public void TestOnSerializeProperty()
        {
            ...
            var xmlSerializer = new FhirXmlSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new SkipActiveCustomSerializer() });
            var xml = xmlSerializer.SerializeToString(pat);
            ...
            var jsonSerializer = new FhirJsonSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new SkipActiveCustomSerializer() });
            var json = jsonSerializer.SerializeToString(pat);
        ...
        public void TestSerializeAnnotation()
        {
            ...
            var xmlSerializer = new FhirXmlSerializer(new ParserSettings(Model.Version.DSTU2) { CustomSerializer = new DumpAnnotationCustomSerializer() });
            var xml = xmlSerializer.SerializeToString(pat);
        ...
        public void AnnotationDeserializer()
        {
            ...
            var xmlDeserializer = new FhirXmlParser(new ParserSettings(Model.Version.DSTU2) { CustomDeserializer = new RetrieveAnnotationCustomDeserializer() });
