...
namespace Hl7.Fhir.Tests.Serialization
{
    ...
    public class SummarySerializationTests
    {
        ...
        public async Tasks.Task TestSummary()
        {
            ...
            q.Item =
            [
                new Questionnaire.ItemComponent() { LinkId = "linkid", Text = new Markdown("TEXT") }
            ];
            ...
            Assert.AreEqual(0, q.Meta.Tag.Count(t => t.System == "http://terminology.hl7.org/CodeSystem/v3-ObservationValue" && t.Code == "SUBSETTED"), "Subsetted Tag should not still be there.");
            ...
            Assert.AreEqual(1, qInflate.Meta.Tag.Count(t => t.System == "http://terminology.hl7.org/CodeSystem/v3-ObservationValue" && t.Code == "SUBSETTED"), "Subsetted Tag should not still be there.");
        }
        ...
        public void TestWithMetadata()
        {
            ...
            Assert.AreEqual(0, p.Meta.Tag.Count(t => t.System == "http://terminology.hl7.org/CodeSystem/v3-ObservationValue" && t.Code == "SUBSETTED"), "Subsetted Tag should not still be there.");
        }
        ...
        public void TestIdInSummary()
        {
            var p = new Patient
            {
                Id = "test-id-1",
                BirthDate = "1972-11-30",     // present in both summary and full
                Photo = [new Attachment() { ContentType = "text/plain", Creation = "45" }],
                ...
                Meta = new Meta(),
                Contained = [new Organization() { Id = "temp", Name = "temp org", Active = true }]
            };
