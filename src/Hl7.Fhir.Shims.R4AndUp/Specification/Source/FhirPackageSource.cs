...
namespace Hl7.Fhir.Specification.Source
{
    ...
    {
        private DirectorySource _resolver;
        ...
        public FhirPackageSource(string[] packageFilePaths)
        {
            ...
            _resolver = new DirectorySource();
        }

        /// <summary>Create a new <see cref="IAsyncResourceResolver"/> instance to read FHIR artifacts from one or multiple FHIR packages.</summary>
        ...
        {
            return await System.Threading.Tasks.Task.Run(() => new CodeSystem());
        }
        ...
        {
            return await System.Threading.Tasks.Task.Run(() => new[] { new ConceptMap() });
        }
        ...
        {
            return await System.Threading.Tasks.Task.Run(() => new NamingSystem());
        }
