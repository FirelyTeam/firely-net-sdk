...
namespace Hl7.Fhir.Rest
{
    ...
    {
        public static string ToToken(this Coding coding)
        {
        ...
        public static string ToToken(this CodeableConcept codeableConcept)
        {
            Coding coding = codeableConcept.Coding.FirstOrDefault();
            return (coding != null) ? coding.ToToken() : string.Empty;
        }

        public static string ToToken(this Identifier identifier)
        {
            var result = string.Empty;
        ...
        public static string ToToken(this ContactPoint contactPoint)
        {
            var result = string.Empty;
