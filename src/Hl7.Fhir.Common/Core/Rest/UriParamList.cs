...
namespace Hl7.Fhir.Rest
{
    ...
    public class UriParamList : List<Tuple<string, string>>
    {
        ...
        public static Predicate<Tuple<string, string>> MatchParam(string key)
        {
        ...
        public static Tuple<string, string> SplitParam(string param)
        {
        ...
        /// <returns></returns>
        public static string MakeParam(string key, string value = null)
        {
        ...
        public static string JoinParam(Tuple<string, string> kv)
        {
