...
namespace Hl7.Fhir.Serialization
{
    internal class PocoBuilder : IExceptionSource
    {
        ...
        public Base BuildFrom(ISourceNode source, Type dataType = null)
        {
            ...
            if (dataType != null)
            {
                typeFound = BaseFhirParser.Inspector.FindClassMappingByType(dataType)?.Name;
        ...
        public Base BuildFrom(ITypedElement source)
        {
            ...
            Base build()
            {
                var typeToBuild = BaseFhirParser.Inspector.FindClassMappingByType(source.InstanceType).NativeType;
