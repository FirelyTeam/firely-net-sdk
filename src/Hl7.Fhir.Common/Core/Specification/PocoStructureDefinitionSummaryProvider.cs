...
namespace Hl7.Fhir.Specification
{
    ...
    public struct PocoComplexTypeSerializationInfo : IStructureDefinitionSummary
    {
    ...
    public struct PocoTypeReferenceInfo : IStructureDefinitionReference
    {
    ...
    public struct PocoElementSerializationInfo : IElementDefinitionSummary
    {
