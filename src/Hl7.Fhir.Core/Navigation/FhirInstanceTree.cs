...
namespace Hl7.Fhir.Navigation
{
    ...
    //public class FhirInstanceTree : DoublyLinkedTree, IDoublyLinkedTree, ILinkedTreeBuilder<DoublyLinkedTree>, IValue
    //{
    //    /// <summary>Static factory method. Creates a new tree node with the specified name.</summary>
    //    /// <param name="name">The name of the node.</param>
    //    /// <returns>A <see cref="FhirInstanceTree"/> node.</returns>
    //    public static FhirInstanceTree Create(string name)
    //    {
