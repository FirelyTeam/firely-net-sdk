...
#pragma warning disable CS1658 // Warning is overriding an error
            ...
            where TResource : Resource
        {
            ...
            return SearchAsync(q, CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)));
        }
        /// <summary>
        /// Search for Resources based on criteria specified in a Query resource
        /// </summary>
        ...
        {
            return SearchUsingPostAsync(q, CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)));
        }

        public Bundle SearchUsingPost<TResource>(SearchParams q) where TResource : Resource
        {
            return SearchUsingPostAsync(q, CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource))).WaitResult();
        }
        ...
        {
            return SearchAsync(CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)), criteria, includes, pageSize, summary, revIncludes);
        }
        ...
        public Task<Bundle> SearchUsingPostAsync<TResource>(string[] criteria, (string path, IncludeModifier modifier)[] includes, int? pageSize,
            ...
            where TResource : Resource, new()
        {
            return SearchUsingPostAsync(CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)), criteria, includes, pageSize, summary, revIncludes);
        }
                ...
                (string path, IncludeModifier modifier)[] revIncludes) where TResource : Resource, new()
        {
            ...
            return SearchByIdAsync(CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)), id, includes, pageSize, revIncludes);
        }
                ...
                (string path, IncludeModifier modifier)[] revIncludes) where TResource : Resource, new()
        {
            ...
            return SearchByIdUsingPostAsync(CommonModelInfo.GetCommonFhirTypeNameForType(_inspector, typeof(TResource)), id, includes, pageSize, revIncludes);
        }
