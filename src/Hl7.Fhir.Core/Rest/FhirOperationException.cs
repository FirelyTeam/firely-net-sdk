...
namespace Hl7.Fhir.Rest
{
    ...
    public class FhirOperationException<TOperationOutcome> : Exception where TOperationOutcome : Resource
    {
        ...
        /// </summary>
        public TOperationOutcome Outcome { get; private set; }
        ...
        /// <summary>Initializes a new instance of the <see cref="FhirOperationException{T}"/> class with a specified error message.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FhirOperationException{T}"/> class with a specified error message
