...
namespace Hl7.Fhir.Specification
{
    ...
    internal struct PocoElementSerializationInfo : IElementDefinitionSummary
    {
        ...
        private ITypeSerializationInfo[] buildTypes()
        {
            ...
            {
                var info = PocoStructureDefinitionSummaryProvider.GetMappingForType(pm.ElementType);
                return new ITypeSerializationInfo[] { new PocoComplexTypeSerializationInfo(info) };
            }
            else
            {              
