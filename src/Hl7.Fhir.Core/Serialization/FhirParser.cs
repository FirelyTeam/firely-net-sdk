...
namespace Hl7.Fhir.Serialization
{
    public class FhirXmlParser : BaseFhirParser
    {
        ...
        public static IFhirReader CreateFhirReader(string xml, bool disallowXsiAttributesOnRoot)
            => new ElementNavFhirReader(XmlDomFhirNavigator.Create(xml, PocoModelMetadataProvider.Default), disallowXsiAttributesOnRoot);
...
#pragma warning disable 612, 618
        ...
        {
            IFhirReader xmlReader = new ElementNavFhirReader(XmlDomFhirNavigator.Create(xml, PocoModelMetadataProvider.Default), Settings.DisallowXsiAttributesOnRoot);
        ...
        {
            IFhirReader xmlReader = new ElementNavFhirReader(XmlDomFhirNavigator.Create(reader, PocoModelMetadataProvider.Default), Settings.DisallowXsiAttributesOnRoot);
            return Parse(xmlReader, dataType);
        }
