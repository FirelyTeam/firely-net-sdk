...
namespace Hl7.Fhir.Model.DSTU2
{
    public static class ElementDefinitionExtensions
    {
        ...
        public static ElementDefinition OfType(this ElementDefinition ed, FHIRDefinedType type, string profile=null, IEnumerable<AggregationMode> aggs=null)
        {
            ed.Type.Clear();
        ...
        public static ElementDefinition OrType(this ElementDefinition ed, FHIRDefinedType type, string profile = null, IEnumerable<AggregationMode> aggs = null)
        {
            var newType = new ElementDefinition.TypeRefComponent { Code = type };
            if (profile != null) newType.Profile = new[] { profile };
            if(aggs != null) newType.Aggregation = aggs.Cast<AggregationMode?>();
