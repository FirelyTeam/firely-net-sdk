...
namespace Hl7.Fhir.FhirPath
{
    public static class ElementNavFhirExtensions
    {
        ...
        public static Func<string, ITypedElement> ToFhirPathResolver(this Func<string, Resource> resolver, Model.Version version)
        {
            return navResolver;
            ...
            ITypedElement navResolver(string url)
            {
                ...
                return resource?.ToTypedElement(version);
            }
        }
        ...
        public static IEnumerable<Base> Select(this Base input, Model.Version version, string expression, FhirEvaluationContext ctx = null)
        {
            var inputNav = input.ToTypedElement(version);
            var result = inputNav.Select(expression, ctx ?? FhirEvaluationContext.CreateDefault());
            return result.ToFhirValues();
        }

        public static object Scalar(this Base input, Model.Version version, string expression, FhirEvaluationContext ctx = null)
        {
            var inputNav = input.ToTypedElement(version);
            return inputNav.Scalar(expression, ctx ?? FhirEvaluationContext.CreateDefault());
        }

        public static bool Predicate(this Base input, Model.Version version, string expression, FhirEvaluationContext ctx = null)
        {
            var inputNav = input.ToTypedElement(version);
            return inputNav.Predicate(expression, ctx ?? FhirEvaluationContext.CreateDefault());
        }

        public static bool IsBoolean(this Base input, Model.Version version, string expression, bool value, FhirEvaluationContext ctx = null)
        {
            var inputNav = input.ToTypedElement(version);
        ...
        {
            return Select(input, version, expression, new FhirEvaluationContext(version, resource));
        }

        [Obsolete("Replace with the overload taking an FhirEvaluationContext, initialized with the resource parameter. Obsolete since 2018-10-17")]
        public static object Scalar(this Base input, Model.Version version, string expression, Resource resource)
        {
            return Scalar(input, version, expression, new FhirEvaluationContext(version, resource));
        }

        [Obsolete("Replace with the overload taking an FhirEvaluationContext, initialized with the resource parameter. Obsolete since 2018-10-17")]
        public static bool Predicate(this Base input, Model.Version version, string expression, Resource resource)
        {
            return Predicate(input, version, expression, new FhirEvaluationContext(version, resource));
        }

        [Obsolete("Replace with the overload taking an FhirEvaluationContext, initialized with the resource parameter")]
        public static bool IsBoolean(this Base input, Model.Version version, string expression, bool value, Resource resource)
        {
            return IsBoolean(input, version, expression, value, new FhirEvaluationContext(version, resource));
        }
        #endregion
