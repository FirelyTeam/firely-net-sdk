...
public static class ArtifactSummaryProperties
{
    ...
    public static object? GetValueOrDefault(this IArtifactSummaryPropertyBag properties, string key)
        => CollectionExtensions.GetValueOrDefault(properties, key);
    ...
    public static bool IsBundleEntry(this IArtifactSummaryPropertyBag properties)
        => properties.GetValueOrDefault(IsBundleEntryKey) is true;
...
{
    private static readonly string NamingSystemTypeName = ResourceType.NamingSystem.GetLiteral();
...
{
    private static readonly string StructureDefinitionTypeName = ResourceType.StructureDefinition.GetLiteral();
    ...
    private static void harvestExtension(ISourceNode nav, IDictionary<string, object> properties, string url)
    {
...
{
    private static readonly string CodeSystemTypeName = ResourceType.CodeSystem.GetLiteral();
...
{
    private static readonly string ConceptMapTypeName = ResourceType.ConceptMap.GetLiteral();
