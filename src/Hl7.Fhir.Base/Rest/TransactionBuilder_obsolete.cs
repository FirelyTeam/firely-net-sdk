...
namespace Hl7.Fhir.Rest
{
    ...
    public partial class TransactionBuilder
    {
        ...
        /// <returns></returns>
        [Obsolete("This overload will be replaced by ConditionalUpdate() for future compliance with Fhir R6. Using the new method is recommended")]
        ...
        /// <param name="bundleEntryFullUrl">Optional parameter to set the <c>fullUrl</c> of the <c>Bundle</c> entry.</param>
        /// <returns></returns>
        [Obsolete("This overload will be replaced by ConditionalPatch() for future compliance with Fhir R6. Using the new method is recommended")]
        ...
        /// <param name="bundleEntryFullUrl">Optional parameter to set the <c>fullUrl</c> of the <c>Bundle</c> entry.</param>
        /// <returns></returns>
        [Obsolete("This overload will be replaced by ConditionalDeleteSingle() and ConditionalDeleteMultiple() for future compliance with Fhir R6. Using the new methods is recommended")]
        ...
        /// <param name="bundleEntryFullUrl">Optional parameter to set the <c>fullUrl</c> of the <c>Bundle</c> entry.</param>
        /// <returns></returns>
        [Obsolete("This overload will be replaced by ConditionalCreate() for future compliance with Fhir R6. Using the new method is recommended")]
