...
public static class ValidationContextExtensions
{
    ...
    /// </summary>
    public static ValidationContext SetLocationProducer(this ValidationContext ctx, Func<string> locationProducer)
    {
        ctx.Items[LOCATION_ITEM_KEY] = locationProducer;
        return ctx;
    }
    ...
    /// </summary>
    public static string? GetLocationProducer(this ValidationContext ctx) =>
