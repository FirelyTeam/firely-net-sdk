...
/// </summary>
/// <remarks>
/// Since the FHIR specification failed to define specific error conditions for terminology service operations,
/// there is not much consistency in how terminology services report errors. This class therefore describes
/// how terminology service implementations in the Firely .NET SDK should report errors, but it cannot be
...
{
    /// <summary>
    /// These are the codes from the Terminology Issue Type code system
    ...
    {
        /// <summary>
        /// Use this error when there is an issue with the provided parameters for an operation,
        ...
        public static FhirOperationException InvalidOperationInvocation(string details)
        {
            ...
            return new FhirOperationException(details, HttpStatusCode.BadRequest, oo);
        }
        ...
        /// but the code is not part of the specified code system
        /// </summary>
        ...
        /// <summary>
        /// The coded parameter well-formed, but misses a system and the system cannot be inferred
        ...
        /// <summary>
        /// The coded parameter is well-formed and can be found in the system, but the display is invalid.
        /// </summary>
        ...
        /// <summary>
        /// The coded parameter is well-formed, but fails a businesss rule for the operation,
        /// e.g. a $subsumes where the codes are not in the same code system.
        /// </summary>
        ...
        public static FhirOperationException Unresolvable(string details)
        {
            ...
            return new FhirOperationException(details, HttpStatusCode.UnprocessableContent, oo);
        }

        /// <summary>
        /// Use this error when the provided (or resolved) ValueSet cannot be processed,
