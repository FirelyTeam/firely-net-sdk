...
public class ValidateCodeParameters : Parameters
{
    ...
    public ValidateCodeParameters(Parameters parameters) : base(parameters.Parameter)
    {
        // Nothing
    }
    ...
    /// </summary>
    public FhirString? SystemVersion
    {
        get => this.GetSingleValue<FhirString>(SYSTEM_VERSION_ATTRIBUTE);
        set => this.SetSingleValue(SYSTEM_VERSION_ATTRIBUTE, value);
    }
    ...
    public FhirBoolean? InferSystem
    {
        get => this.GetSingleValue<FhirBoolean>(INFER_SYSTEM_ATTRIBUTE);
        set => this.SetSingleValue(INFER_SYSTEM_ATTRIBUTE, value);
    }
