...
public static class FhirSerializationEngineFactory
{
    ...
    public static IFhirSerializationEngine Strict(ModelInspector inspector,
        ...
        new PocoSerializationEngine(inspector, converterOptions: converterOptions);
    ...
    public static IFhirSerializationEngine BackwardsCompatible(ModelInspector inspector,
        FhirJsonConverterOptions? converterOptions = null) =>
        new PocoSerializationEngine(inspector, FilterPredicateExtensions.IsBackwardsCompatibilityIssue, converterOptions);
