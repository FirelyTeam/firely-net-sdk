...
public record FhirXmlPocoDeserializerSettings
{
    /// <summary>
    ...
    /// </summary>
    public Predicate<CodedException>? ExceptionFilter { get; set; } = null;
    ...
    public FhirXmlPocoDeserializerSettings WithMode(DeserializationMode mode,
    ...
    /// </summary>
    public FhirXmlPocoDeserializerSettings Enforcing(IEnumerable<string> toEnforce) =>
        this with { ExceptionFilter = this.ExceptionFilter.Enforce(toEnforce) };

    /// <summary>
    /// Alters the options to ignore specific parsing exceptions.
    /// </summary>
    public FhirXmlPocoDeserializerSettings Ignoring(IEnumerable<string> toIgnore) =>
