...
namespace Hl7.Fhir.Serialization
{
    public class FhirXmlException : ExtendedCodedException
    {
        ...
        internal static FhirXmlException UNKNOWN_ELEMENT(XmlReader reader, string instancePath, string elementName) => Initialize(reader, instancePath, UNKNOWN_ELEMENT_CODE, $"Encountered unrecognized element '{elementName}'.", OO_Sev.Error, OO_Typ.Structure);
        internal static FhirXmlException CHOICE_ELEMENT_HAS_NO_TYPE(XmlReader reader, string instancePath, string elementName) => Initialize(reader, instancePath, CHOICE_ELEMENT_HAS_NO_TYPE_CODE, $"Choice element '{elementName}' is not suffixed with a type.", OO_Sev.Error, OO_Typ.Structure);
        ...
        internal static FhirXmlException UNKNOWN_ATTRIBUTE(XmlReader reader, string instancePath, string s0) => Initialize(reader, instancePath, UNKNOWN_ATTRIBUTE_CODE, $"Encountered unrecognized attribute '{s0}'.", OO_Sev.Error, OO_Typ.Structure);
        ...
        internal static FhirXmlException UNALLOWED_NODE_TYPE(XmlReader reader, string instancePath, string s0) => Initialize(reader, instancePath, UNALLOWED_NODE_TYPE_CODE, $"Xml node of type '{s0}' is unexpected at this point", OO_Sev.Error, OO_Typ.Structure);
