...
// Generated Shared Enumeration: DeviceType (http://hl7.org/fhir/ValueSet/device-type)
  // Used in model class (resource): BodyStructure.includedStructure.bodyLandmarkOrientation.distanceFromLandmark.device
  // Used in model class (resource): ChargeItem.product
  // Used in model class (resource): Device.definition
  // Used in model class (resource): Device.type
  // Used in model class (resource): DeviceDefinition.classification.type
  // Used in model class (resource): DeviceRequest.code
  // Used in model class (resource): Procedure.used
...
// Generated Shared Enumeration: SequenceType (http://hl7.org/fhir/ValueSet/sequence-type)
  // Used in model class (resource): MolecularDefinition.type
  // Used in model class (resource): MolecularSequence.type
