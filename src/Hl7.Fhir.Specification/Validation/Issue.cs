...
//        public static readonly Issue CONTENT_ELEMENT_HAS_UNKNOWN_TYPE = def(1002, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Invalid);
        ...
        public static readonly Issue CONTENT_ELEMENT_VALUE_TOO_LONG = def(1005, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Value);
        public static readonly Issue CONTENT_ELEMENT_INVALID_PRIMITIVE_VALUE = def(1006, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Value);
        ...
        public static readonly Issue CONTENT_DOES_NOT_MATCH_FIXED_VALUE = def(1008, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Value);
        public static readonly Issue CONTENT_DOES_NOT_MATCH_PATTERN_VALUE = def(1009, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Value);
        ...
        public static readonly Issue CONTENT_ELEMENT_CHOICE_INVALID_INSTANCE_TYPE = def(1011, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Invalid);
        public static readonly Issue CONTENT_ELEMENT_FAILS_ERROR_CONSTRAINT = def(1012, OperationOutcome.IssueSeverity.Error, OperationOutcome.IssueType.Invariant);
        public static readonly Issue CONTENT_ELEMENT_FAILS_WARNING_CONSTRAINT = def(1013, OperationOutcome.IssueSeverity.Warning, OperationOutcome.IssueType.Invariant);
        ...
        public static readonly Issue PROFILE_ELEMENTDEF_INVALID_FLUENTPATH_EXPRESSION = def(2009, OperationOutcome.IssueSeverity.Warning, OperationOutcome.IssueType.BusinessRule);
        ...
        public static readonly Issue UNSUPPORTED_CONSTRAINT_WITHOUT_FLUENTPATH = def(3003, OperationOutcome.IssueSeverity.Warning, OperationOutcome.IssueType.Incomplete);
        ...
        public static readonly Issue UNAVAILABLE_SNAPSHOT_GENERATION_FAILED = def(4003, OperationOutcome.IssueSeverity.Warning, OperationOutcome.IssueType.Incomplete);
        ...
        public static readonly Issue PROCESSING_CONSTRAINT_VALIDATION_INACTIVE = def(5001, OperationOutcome.IssueSeverity.Information, OperationOutcome.IssueType.Informational);
    }
