...
namespace Hl7.Fhir.Specification.Source.Summary
{
    ...
    public static class ArtifactSummaryExtensions
    {
        ...
        /// Alternatively, the <see cref="LoadResource(ArtifactSummary, Stream)"/> extension method
        /// supports loading resources from a stream.
        /// </para>
        /// </summary>
        ...
        /// <seealso cref="LoadResource(ArtifactSummary, Stream)"/>
        ...
        /// Alternatively, the <see cref="LoadResource(ArtifactSummary)"/> extension method supports
        ...
        /// <returns>A new <see cref="Resource"/> instance, or <c>null</c>.</returns>
        /// <seealso cref="LoadResource(ArtifactSummary)"/>
        public static Resource LoadResource(this ArtifactSummary summary, Stream stream) => summary.LoadResource<Resource>(stream);
