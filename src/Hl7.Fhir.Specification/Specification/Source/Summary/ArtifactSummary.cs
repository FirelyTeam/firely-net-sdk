...
namespace Hl7.Fhir.Specification.Source.Summary
{
    ...
    /// <remarks>
    /// Generated by the <see cref="ArtifactSummaryGenerator"/> class
    /// from an initialized <see cref="ArtifactSummaryPropertyBag"/> instance.
    /// <para>
    /// Also implements the <see cref="IArtifactSummaryPropertyBag"/> interface, so
    /// consumers can use the extension methods defined by the summary harvester
    /// classes to access the harvested properties.
    /// </para>
    /// </remarks>
    ...
    public class ArtifactSummary : IArtifactSummaryPropertyBag
    {
        ...
        protected readonly ArtifactSummaryPropertyBag properties;
        ...
        /// <param name="properties">A <see cref="ArtifactSummaryPropertyBag"/> with harvested artifact summary information.</param>
        public ArtifactSummary(ArtifactSummaryPropertyBag properties) : this(properties, null) { }
        ...
        /// </summary>
        public ArtifactSummary(ArtifactSummaryPropertyBag properties, Exception error)
        {
