...
namespace Hl7.Fhir.Specification.Source
{
    ...
    {
        private const string FHIR_CORE_PACKAGE_NAME = "hl7.fhir.r4.corexml@4.0.1";
        private const string FHIR_CORE_EXPANSIONS_PACKAGE_NAME = "hl7.fhir.r4.expansions@4.0.1";
