...
namespace Hl7.Fhir.Specification.Source
{
    ...
    public static class CorePackageFileNames
    {
        ...
        internal const string FHIR_CORE_PACKAGE_NAME = "hl7.fhir.r3.corexml@3.0.2";
        internal const string FHIR_CORE_EXPANSIONS_PACKAGE_NAME = "hl7.fhir.r3.expansions@3.0.2";
