...
namespace Hl7.Fhir.Serialization.Tests
{
    ...
    public class SummaryTests
    {
        ...
        public void Summary()
        {
            ...
            var typeinfo = new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2).Provide("Patient");
        ...
        public void SummaryText()
        {
            ...
            var typeinfo = new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2).Provide("ValueSet");
