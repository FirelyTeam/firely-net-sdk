...
namespace Hl7.Fhir.Serialization.Tests
{
    ...
    public class ParseDemoPatientXmlTyped
    {
        public ITypedElement getXmlNode(string xml, FhirXmlParsingSettings settings = null, TypedElementSettings tnSettings = null)
        {
            ...
            return XmlParsingHelpers.ParseToTypedElement(xml, new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2), settings, tnSettings);
        }
        ...
        public void CompareXmlJsonParseOutcomes()
        {
            ...
            var navJson = JsonParsingHelpers.ParseToTypedElement(tpJson, new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2));
        ...
        {
            ParseDemoPatient.RoundtripXml(reader => XmlParsingHelpers.ParseToTypedElement(reader, new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2)));
        }
        ...
        public void PingpongXml()
        {
            ...
            var navXml = XmlParsingHelpers.ParseToTypedElement(tp, new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2));
            var json = navXml.ToJson();

            var navJson = JsonParsingHelpers.ParseToTypedElement(json, new PocoStructureDefinitionSummaryProvider(Model.Version.DSTU2));
