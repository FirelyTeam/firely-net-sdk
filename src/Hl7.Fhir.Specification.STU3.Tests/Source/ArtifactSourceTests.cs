...
namespace Hl7.Fhir.Specification.Tests
{
    ...
    public class ArtifactSourceTests
    {
        ...
        public void UseFileArtifactSource()
        {
            ...
            Assert.Contains("extension-definitions.xml", names);
        ...
        public void TestZipSourceMask()
        {
            ...
            Assert.Contains(url, coreTypeUris.All(url => resourceIds));
            Assert.Contains(url, resourceIds.All(url => coreTypeUris));
        }
