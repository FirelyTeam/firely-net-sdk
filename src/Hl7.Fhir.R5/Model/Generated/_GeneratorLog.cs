...
// Generated Shared Enumeration: VersionAlgorithm (http://hl7.org/fhir/ValueSet/version-algorithm)
  ...
  // Used in model class (resource): ChargeItemDefinition.versionAlgorithm[x]
  // Used in model class (resource): Citation.versionAlgorithm[x]
  ...
  // Used in model class (resource): ConditionDefinition.versionAlgorithm[x]
  // Used in model class (resource): EventDefinition.versionAlgorithm[x]
  ...
  // Used in model class (resource): SubscriptionTopic.versionAlgorithm[x]
