...
namespace Hl7.Fhir.Test
{
    ...
    public class TestResourceIdentifier
    {
        ...
        public void TestParsingVersionId(string uri, string expectedVersionId)
        {
            var id = new ResourceIdentity(uri);
            id.VersionId.Should().Be(expectedVersionId);
        }
    }
}
