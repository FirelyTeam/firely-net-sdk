...
namespace Hl7.Fhir.ElementModel.Tests
{
    ...
    public class AnyTests
    {
        ...
        public void AnyParse()
        {
            ...
            {
                yield return ("true", typeof(P.Boolean), true, (P.Boolean)true);
                ...
                yield return ("false", typeof(P.Boolean), true, (P.Boolean)false);
                ...
                yield return ("hallo", typeof(P.String), true, (P.String)"hallo");

                yield return ("34", typeof(P.Integer), true, (P.Integer)34);
                yield return ("-34", typeof(P.Integer), true, (P.Integer)(-34));
                yield return ("+34", typeof(P.Integer), true, (P.Integer)34);
                yield return ("34.5", typeof(P.Integer), false, default);

                yield return ("64", typeof(P.Long), true, (P.Long)64);
                yield return ("-64", typeof(P.Long), true, (P.Long)(-64L));
                yield return ("+64", typeof(P.Long), true, (P.Long)64L);
                yield return ("64.5", typeof(P.Integer), false, default);


                yield return ("34", typeof(P.Decimal), true, (P.Decimal)34m);
                yield return ("0034", typeof(P.Decimal), true, (P.Decimal)34m);
                yield return ("34.0", typeof(P.Decimal), true, (P.Decimal)34.0m);
                yield return ("-34", typeof(P.Decimal), true, (P.Decimal)(-34m));
                yield return ("3e+4", typeof(P.Decimal), true, (P.Decimal)3e+4m);
            ...
            foreach (var (value, to, success, expected) in tests())
            {
                ...
                Assert.AreEqual(success, P.Any.TryParseToAny(value, to, out var parsed), $"While parsing {value} for type {to}");
