...
namespace Firely.Fhir.Packages.Tests
{
    ...
    {
        private const string CORE_PACKAGE_PATH = "TestData/hl7.fhir.r4b.corexml.tgz";
        private const string CORE_EXPANSIONS_PACKAGE_PATH = "TestData/hl7.fhir.r4b.expansions.tgz";
