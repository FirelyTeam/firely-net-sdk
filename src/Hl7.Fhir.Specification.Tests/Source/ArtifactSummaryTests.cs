...
namespace Hl7.Fhir.Specification.Tests
{
    ...
    public class ArtifactSummaryTests
    {
        ...
        public void TestZipSummary()
        {
            ...
            // [MV 20210423] 4.3.0-snapshot1 (R4B) summaries from 3613 to 3606, and SDs from 644 to 645
            Assert.AreEqual(3606, summaries.Count); // STU3: 7941
            Assert.AreEqual(645, summaries.OfResourceType(ResourceType.StructureDefinition).Count()); // STU3: 581
