...
namespace Hl7.Fhir.Specification.Tests
{
    ...
    public class SummarySourceTests
    {
        ...
        public void GetSomeArtifactsBySummary()
        {
            ...
            var vs = fa.LoadFromSummary(summary);
            ...
            Assert.IsNotNull(summary);
            var rs = fa.LoadFromSummary(summary);
            Assert.IsNotNull(rs);
            ...
            Assert.IsNotNull(summary);
            var ext = fa.LoadFromSummary(summary);
            ...
            Assert.IsNotNull(summary);
            var us = fa.LoadFromSummary(summary);
            Assert.IsNotNull(us);
