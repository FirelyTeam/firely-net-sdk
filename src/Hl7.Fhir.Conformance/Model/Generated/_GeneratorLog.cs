...
// Deferred generation of Shared Enumeration (will be generated in another subset): VersionAlgorithm (http://hl7.org/fhir/ValueSet/version-algorithm)
  // Used in model class (resource): ActivityDefinition.versionAlgorithm[x]
  // Used in model class (resource): ActorDefinition.versionAlgorithm[x]
  // Used in model class (resource): CanonicalResource.versionAlgorithm[x]
  // Used in model class (resource): CapabilityStatement.versionAlgorithm[x]
  // Used in model class (resource): CodeSystem.versionAlgorithm[x]
  // Used in model class (resource): CompartmentDefinition.versionAlgorithm[x]
  // Used in model class (resource): ConceptMap.versionAlgorithm[x]
  // Used in model class (resource): Evidence.versionAlgorithm[x]
  // Used in model class (resource): EvidenceVariable.versionAlgorithm[x]
  // Used in model class (resource): ExampleScenario.versionAlgorithm[x]
  // Used in model class (resource): GraphDefinition.versionAlgorithm[x]
  // Used in model class (resource): ImplementationGuide.versionAlgorithm[x]
  // Used in model class (resource): Library.versionAlgorithm[x]
  // Used in model class (resource): Measure.versionAlgorithm[x]
  // Used in model class (resource): MessageDefinition.versionAlgorithm[x]
  // Used in model class (resource): NamingSystem.versionAlgorithm[x]
  // Used in model class (resource): ObservationDefinition.versionAlgorithm[x]
  // Used in model class (resource): OperationDefinition.versionAlgorithm[x]
  // Used in model class (resource): PlanDefinition.versionAlgorithm[x]
  // Used in model class (resource): Questionnaire.versionAlgorithm[x]
  // Used in model class (resource): Requirements.versionAlgorithm[x]
  // Used in model class (resource): SearchParameter.versionAlgorithm[x]
  // Used in model class (resource): SpecimenDefinition.versionAlgorithm[x]
  // Used in model class (resource): StructureDefinition.versionAlgorithm[x]
  // Used in model class (resource): StructureMap.versionAlgorithm[x]
  // Used in model class (resource): TerminologyCapabilities.versionAlgorithm[x]
  // Used in model class (resource): TestScript.versionAlgorithm[x]
  // Used in model class (resource): ValueSet.versionAlgorithm[x]
  // Used in model class (resource): Definition.versionAlgorithm[x]
  // Used in model class (resource): Shareable.versionAlgorithm[x]
