...
| 4 | Empirical cross-check (shared test cases, Java-oracle harness) | **in progress** (packet 1 done 2026-08-26: three-way harness built in materials dir — JavaRunner [engine 6.10.2, JUnit-driver config] + .NET runner [NuGet 6.2.1] + equalsDeep comparer + manifest driver; Java oracle reproduces golden on 7/7 runnable milestone tests; first findings incl. obs-2b `value[x]` min 0-vs-1 and 8 deviation-candidate classes — see materials `extracts/harness-first-runs-2026-08-26.md`) |
