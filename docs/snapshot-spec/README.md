...
| 4 | Empirical cross-check (shared test cases, Java-oracle harness) | pending — **pulled forward: next packet** (WGM brief freezes ~2026-09-14; harness answers beat exhaustive reading) |
